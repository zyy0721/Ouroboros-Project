...
#strLine = "  %.sub = getelementptr inbounds [16 x i8], [16 x i8]* %34, i64 0, i64 0"
#strLine  ="  %arraydecay.i322 = getelementptr inbounds %'struct.icu_63::(anonymous namespace)::CEIBuffer', %'struct.icu_63::(anonymous namespace)::CEIBuffer'* %ceb, i64 0, i32 0, i64 0, !dbg !416360"
#strLine = "  %allowed.sroa.11 = alloca <{ i8, [5 x i8] }>, align 2"
#strLine = "  %ptr.i.i = getelementptr inbounds %'class.mozilla::dom::(anonymous namespace)::EventRunnable', %'class.mozilla::dom::(anonymous namespace)::EventRunnable'* %this, i64 0, i32 20, i32 1, !dbg !3200869"
#strLine = "  %mScopeObj = getelementptr inbounds %'class.mozilla::dom::(anonymous namespace)::EventRunnable', %'class.mozilla::dom::(anonymous namespace)::EventRunnable'* %this, i64 0, i32 20, !dbg !3200858"
#strLine = "  %26 = getelementptr inbounds %'class.mozilla::dom::indexedDB::(anonymous namespace)::MutableFile', %'class.mozilla::dom::indexedDB::(anonymous namespace)::MutableFile'* %25, i64 0, i32 0, i32 0, !dbg !14311078"
#strLine = "  %3 = load i8*, i8** bitcast (void ()*** @sqlite3Autoext.1 to i8**), align 8, !dbg !83842"
#strLine = "  %11 = load %'class.mozilla::GenericRefCountedBase'*, %'class.mozilla::GenericRefCountedBase'** bitcast ([16 x i8*]* @_ZZN2vr28OpenVRInternal_ModuleContextEvE3ctx to %'class.mozilla::GenericRefCountedBase'**), align 16, !dbg !1338473"
#strLine = "  %call28.idx.i = getelementptr %'class.mozilla::HashMapEntry.1024', %'class.mozilla::HashMapEntry.1024'* %57, i64 0, i32 0, i32 0, i32 0, i32 0"
#strLine = "  %arrayidx77 = getelementptr inbounds [16 x [2 x [3344 x i8]]], [16 x [2 x [3344 x i8]]]* @iwt_matrix_ref, i64 0, i64 %indvars.iv151, i64 0, i64 %idxprom61, !dbg !1095473"
#strLine = "  %arrayidx62.1 = getelementptr inbounds [16 x [2 x [3344 x i8]]], [16 x [2 x [3344 x i8]]]* @wt_matrix_ref, i64 0, i64 %indvars.iv151, i64 1, i64 %idxprom61.1, !dbg !1095469"
#strLine = "  %arrayidx77.2 = getelementptr inbounds [16 x [2 x [3344 x i8]]], [16 x [2 x [3344 x i8]]]* @iwt_matrix_ref, i64 0, i64 %indvars.iv151, i64 1, i64 %idxprom61.2, !dbg !1095473"
#strLine = "  %arraydecay = getelementptr inbounds [15 x [2 x [32 x i8]]], [15 x [2 x [32 x i8]]]* @qm_tbl_8x4, i64 0, i64 %indvars.iv554, i64 %indvars.iv, i64 0, !dbg !1194520"
#strLine = "  %arrayidx11 = getelementptr inbounds [16 x [2 x [19 x i8*]]], [16 x [2 x [19 x i8*]]]* @dav1d_qm_tbl, i64 0, i64 %indvars.iv554, i64 %indvars.iv, i64 5, !dbg !1194523"
#strLine = "  %arrayidx.i536 = getelementptr inbounds [15 x [2 x [64 x i8]]], [15 x [2 x [64 x i8]]]* @qm_tbl_16x4, i64 0, i64 %indvars.iv554, i64 %indvars.iv, i64 %indvars.iv37.i528, !dbg !1194572"
#strLine = "  %addr.i.i = getelementptr inbounds [100 x %struct.nr_local_addr_.1353], [100 x %struct.nr_local_addr_.1353]* %local_addrs, i64 0, i64 %indvars.iv330, i32 0, i32 2, !dbg !796203"
#strLine = "  %u.i.i = getelementptr inbounds [100 x %struct.nr_local_addr_.1353], [100 x %struct.nr_local_addr_.1353]* %local_addrs, i64 0, i64 %indvars.iv330, i32 0, i32 4, !dbg !796202"
#strLine = "  %addr6.i.i = getelementptr inbounds [100 x %struct.nr_local_addr_.1353], [100 x %struct.nr_local_addr_.1353]* %local_addrs, i64 0, i64 %indvars.iv330, i32 0, i32 4, i32 0, !dbg !796206"
#strLine = "  %addr3.i.i = getelementptr inbounds [100 x %struct.nr_local_addr_.1353], [100 x %struct.nr_local_addr_.1353]* %local_addrs, i64 0, i64 %indvars.iv330, i32 0, i32 2, !dbg !796207"
#strLine = "  %state_.i48 = getelementptr inbounds %'struct.std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> >::_Alloc_hider', %'struct.std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> >::_Alloc_hider'* %13, i64 0, i32 0, !dbg !2358788"
#strLine = "  %13 = load %'struct.std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> >::_Alloc_hider'*, %'struct.std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> >::_Alloc_hider'** %_M_head_impl.i.i.i.i.i.i49, align 8, !dbg !2358785"
#strLine = "  %_M_head_impl.i.i.i.i.i.i49 = getelementptr inbounds %'class.std::unique_ptr.13688', %'class.std::unique_ptr.13688'* %__begin1.sroa.0.056, i64 0, i32 0, i32 0, i32 0, i32 0, !dbg !2358784"
#strLine = "  %codecParams.sroa.5 = alloca { i32, [32 x i8], i32 }, align 8"
#strLine = "  %codecParams.sroa.11 = alloca { i8, i32, i32, i32, [4 x %struct.TileInfo] }, align 8"
#strLine = "  %state_.i = getelementptr inbounds %'struct.std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> >::_Alloc_hider', %'struct.std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> >::_Alloc_hider'* %3, i64 0, i32 0, !dbg !2360062"
#strLine = "  %3 = load %'struct.std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> >::_Alloc_hider'*, %'struct.std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> >::_Alloc_hider'** %_M_head_impl.i.i.i.i.i.i, align 8, !dbg !2360059"
#strLine = "  %state_.i = getelementptr inbounds %'struct.std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> >::_Alloc_hider', %'struct.std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> >::_Alloc_hider'* %4, i64 0, i32 0, !dbg !2358465"
#strLine = "  %4 = load %'struct.std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> >::_Alloc_hider'*, %'struct.std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char> >::_Alloc_hider'** %_M_head_impl.i.i.i.i.i.i, align 8, !dbg !2358462"
#strLine = "  %_M_right.i.i.i.i.i = getelementptr inbounds [1 x %'struct.webrtc::SdpVideoFormat'], [1 x %'struct.webrtc::SdpVideoFormat']* %ref.tmp, i64 0, i64 0, i32 1, i32 0, i32 0, i32 1, i32 3, !dbg !3273277"
#strLine = "  %_M_header.i.i.i.i = getelementptr inbounds [1 x %'struct.webrtc::SdpVideoFormat'], [1 x %'struct.webrtc::SdpVideoFormat']* %ref.tmp, i64 0, i64 0, i32 1, i32 0, i32 0, i32 1, !dbg !3273271"
#strLine = "  %_M_left.i.i.i.i.i = getelementptr inbounds [1 x %'struct.webrtc::SdpVideoFormat'], [1 x %'struct.webrtc::SdpVideoFormat']* %ref.tmp, i64 0, i64 0, i32 1, i32 0, i32 0, i32 1, i32 2, !dbg !3273274"
#strLine = "  %5 = getelementptr inbounds [1 x %'struct.webrtc::SdpVideoFormat'], [1 x %'struct.webrtc::SdpVideoFormat']* %ref.tmp, i64 0, i64 0, i32 0, i32 2, !dbg !3273215"
#strLine = "  %mLock.i.i.i = getelementptr inbounds %'class.mozilla::storage::(anonymous namespace)::UnlockNotification', %'class.mozilla::storage::(anonymous namespace)::UnlockNotification'* %notification, i64 0, i32 1, i32 0, i32 0, !dbg !60694"
#strLine = "  %2 = getelementptr inbounds %'class.mozilla::storage::(anonymous namespace)::UnlockNotification', %'class.mozilla::storage::(anonymous namespace)::UnlockNotification'* %notification, i64 0, i32 0, i32 0, !dbg !60675"
#strLine = "  %mFileName.i.i.i.i121 = getelementptr inbounds %'struct.mozilla::CodeAddressService<CodeAddressServiceStringTable, CodeAddressServiceStringAlloc, CodeAddressServiceLock>::Entry', %'struct.mozilla::CodeAddressService<CodeAddressServiceStringTable, CodeAddressServiceStringAlloc, CodeAddressServiceLock>::Entry'* %arraydestroy.elementPast.i.i.i118, i64 -1, i32 4, !dbg !293435"
#strLine = "  %arraydestroy.element.i.i.i119 = getelementptr inbounds %'struct.mozilla::CodeAddressService<CodeAddressServiceStringTable, CodeAddressServiceStringAlloc, CodeAddressServiceLock>::Entry', %'struct.mozilla::CodeAddressService<CodeAddressServiceStringTable, CodeAddressServiceStringAlloc, CodeAddressServiceLock>::Entry'* %arraydestroy.elementPast.i.i.i118, i64 -1, !dbg !293428"
#strLine = "  %mFileName.i.i.i.i = getelementptr inbounds %'struct.mozilla::CodeAddressService<CodeAddressServiceStringTable, CodeAddressServiceStringAlloc, CodeAddressServiceLock>::Entry', %'struct.mozilla::CodeAddressService<CodeAddressServiceStringTable, CodeAddressServiceStringAlloc, CodeAddressServiceLock>::Entry'* %arraydestroy.elementPast.i.i.i, i64 -1, i32 4, !dbg !293498"
#strLine = "  %attr7 = getelementptr [25 x %struct.amd_iommu_event_desc], [25 x %struct.amd_iommu_event_desc]* @amd_iommu_v2_event_descs, i64 0, i64 %indvars.iv, i32 0, i32 0, !dbg !5727"
#strLine = "  %attr = getelementptr [64 x %struct.mlog_attribute], [64 x %struct.mlog_attribute]* bitcast (<{ [20 x %struct.mlog_attribute], [44 x %struct.mlog_attribute] }>* @mlog_attrs to [64 x %struct.mlog_attribute]*), i64 0, i64 %idxprom15, i32 0, !dbg !52583"
#strLine = "  %0 = load i16, i16* getelementptr inbounds (<{ [20 x %struct.mlog_attribute], [44 x %struct.mlog_attribute] }>, <{ [20 x %struct.mlog_attribute], [44 x %struct.mlog_attribute] }>* @mlog_attrs, i64 0, i32 0, i64 0, i32 0, i32 1), align 8, !dbg !52581"
#strLine = "  %arrayidx3.i.i = getelementptr %struct.net, %struct.net* %net, i64 0, i32 40, i32 16, i32 7, i32 1, i64 1, !dbg !11231"
#strLine = "  %u312.i = getelementptr %struct.nf_conn, %struct.nf_conn* %47, i64 0, i32 4, i64 %idxprom8.i, i32 1, i32 0, i32 0, !dbg !11724"
#strLine = "  %port50 = getelementptr %struct.nf_conn, %struct.nf_conn* %ct, i64 0, i32 4, i64 %idxprom35, i32 1, i32 1, i32 1, i32 0, !dbg !11699"
#strLine = "  %ip39 = getelementptr %struct.nf_conn, %struct.nf_conn* %ct, i64 0, i32 4, i64 %idxprom35, i32 1, i32 1, i32 0, i32 0, i64 0, !dbg !11699"
#strLine = "  %call.i = call fastcc i32 @set_addr(%struct.sk_buff* %skb, i32 %protoff, i8** %data, i32 0, i32 %11, i32 %12, i16 zeroext %10) #9, !dbg !11719"
#strLine = "  %arraydecay159.i = getelementptr %struct.smc_link_group, %struct.smc_link_group* %132, i64 0, i32 13, i32 0, i32 1, i64 0, i32 26, i64 0, !dbg !13166"
#strLine = "  %arrayidx104.i.i = getelementptr %struct.smc_link_group, %struct.smc_link_group* %132, i64 0, i32 13, i32 0, i32 1, i64 0, i32 26, i64 12, !dbg !13181"
#strLine = "  %arraydecay = getelementptr [4 x [8192 x i8]], [4 x [8192 x i8]]* bitcast (<{ <{ [453 x i8], [7739 x i8] }>, [8192 x i8], [8192 x i8], [8192 x i8] }>* @ff_eeimg to [4 x [8192 x i8]]*), i64 0, i64 %indvars.iv, i64 0, !dbg !2856"
#strLine = "  %call.i = call noalias i8* @devm_kmalloc(%struct.device* %dev, i64 2592, i32 3520) #9, !dbg !4722"
#strLine = "  %owner = getelementptr [6 x %struct.sch311x_gpio_block], [6 x %struct.sch311x_gpio_block]* %blocks, i64 0, i64 %indvars.iv129, i32 0, i32 3, !dbg !4756"
#strLine = "  %parent = getelementptr [6 x %struct.sch311x_gpio_block], [6 x %struct.sch311x_gpio_block]* %blocks, i64 0, i64 %indvars.iv129, i32 0, i32 2, !dbg !4776"
#strLine = "  %arraydecay = getelementptr [6 x %struct.sch311x_gpio_block_def], [6 x %struct.sch311x_gpio_block_def]* @sch311x_gpio_blocks, i64 0, i64 %indvars.iv129, i32 1, i64 0, !dbg !4782"
#strLine = "  %arrayidx3.i = getelementptr %struct.amdgpu_device, %struct.amdgpu_device* %0, i64 0, i32 97, i32 0, i64 %indvars.iv.i7, i32 3, i32 3, i32 4, i64 4, !dbg !12173"
#strLine = "  %funcs.i = getelementptr %struct.amdgpu_device, %struct.amdgpu_device* %0, i64 0, i32 97, i32 0, i64 %indvars.iv.i, i32 3, i32 1, !dbg !12128"
#strLine = "  %attrs33 = getelementptr inbounds %struct.drm_i915_private, %struct.drm_i915_private* %dev_priv, i64 0, i32 120, i32 7, i32 10, i32 8, i32 3, !dbg !14583"
#strLine = "  %attrs33 = getelementptr inbounds %struct.drm_i915_private, %struct.drm_i915_private* %dev_priv, i64 0, i32 120, i32 7, i32 10, i32 8, i32 3, !dbg !14583"
#strLine = "  %arraydecay28 = getelementptr %struct.drm_i915_private, %struct.drm_i915_private* %dev_priv, i64 0, i32 120, i32 7, i32 10, i32 9, i64 0, !dbg !14582"
#strLine = "  %mux_regs = getelementptr inbounds %struct.drm_i915_private, %struct.drm_i915_private* %dev_priv, i64 0, i32 120, i32 7, i32 10, i32 2, !dbg !14568"
#strLine = "  store %struct.i915_oa_reg* getelementptr inbounds ([14 x %struct.i915_oa_reg], [14 x %struct.i915_oa_reg]* @mux_config_test_oa, i64 0, i64 0), %struct.i915_oa_reg** %mux_regs, align 8, !dbg !14569"
#strLine = "  store %struct.i915_oa_reg* getelementptr inbounds ([22 x %struct.i915_oa_reg], [22 x %struct.i915_oa_reg]* @b_counter_config_test_oa, i64 0, i64 0), %struct.i915_oa_reg** %b_counter_regs, align 8, !dbg !14573"
#strLine = "  store i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str, i64 0, i64 0), i8** %name, align 8, !dbg !14581"
#strLine = "  store %struct.attribute** %arraydecay28, %struct.attribute*** %attrs33, align 8, !dbg !14584"
#strLine = "  %funcs.i = getelementptr %struct.amdgpu_device, %struct.amdgpu_device* %0, i64 0, i32 97, i32 0, i64 %indvars.iv.i, i32 3, i32 1, !dbg !12095"
#strLine = "  %arrayidx6.i = getelementptr %struct.amdgpu_device, %struct.amdgpu_device* %0, i64 0, i32 66, i32 10, i64 %indvars.iv.i8, !dbg !12131"
#strLine = "  %arrayidx3.i = getelementptr %struct.amdgpu_device, %struct.amdgpu_device* %0, i64 0, i32 97, i32 0, i64 %indvars.iv.i8, i32 3, i32 3, i32 4, i64 4, !dbg !12129"
#strLine = "  %arrayidx3.i = getelementptr %struct.amdgpu_device, %struct.amdgpu_device* %0, i64 0, i32 97, i32 0, i64 %indvars.iv.i11, i32 3, i32 3, i32 4, i64 4, !dbg !12223"
#strLine = "  %arrayidx7.i = getelementptr %struct.amdgpu_device, %struct.amdgpu_device* %0, i64 0, i32 97, i32 0, i64 %indvars.iv74.i, i32 4, i32 3, i32 4, i64 4, !dbg !12432"
#strLine = "  %arraydecay39 = getelementptr [18 x %struct.abituguru3_motherboard_info], [18 x %struct.abituguru3_motherboard_info]* bitcast (<{ { i16, [3 x i8*], <{ [19 x %struct.abituguru3_sensor_info], [8 x %struct.abituguru3_sensor_info] }> }, %struct.abituguru3_motherboard_info, { i16, [3 x i8*], <{ [18 x %struct.abituguru3_sensor_info], [9 x %struct.abituguru3_sensor_info] }> }, { i16, [3 x i8*], <{ [18 x %struct.abituguru3_sensor_info], [9 x %struct.abituguru3_sensor_info] }> }, { i16, [3 x i8*], <{ [19 x %struct.abituguru3_sensor_info], [8 x %struct.abituguru3_sensor_info] }> }, %struct.abituguru3_motherboard_info, { i16, [3 x i8*], <{ [19 x %struct.abituguru3_sensor_info], [8 x %struct.abituguru3_sensor_info] }> }, %struct.abituguru3_motherboard_info, { i16, [3 x i8*], <{ [18 x %struct.abituguru3_sensor_info], [9 x %struct.abituguru3_sensor_info] }> }, %struct.abituguru3_motherboard_info, %struct.abituguru3_motherboard_info, %struct.abituguru3_motherboard_info, %struct.abituguru3_motherboard_info, %struct.abituguru3_motherboard_info, %struct.abituguru3_motherboard_info, %struct.abituguru3_motherboard_info, %struct.abituguru3_motherboard_info, %struct.abituguru3_motherboard_info }>* @abituguru3_motherboards to [18 x %struct.abituguru3_motherboard_info]*), i64 0, i64 %idxprom, i32 2, i64 0, !dbg !3039"
#strLine = "  %name26 = getelementptr %struct.ibmpex_sensor_data, %struct.ibmpex_sensor_data* %6, i64 %indvars.iv, i32 3, i64 0, i32 0, i32 0, i32 0, !dbg !4160"
#strLine = "  %name101.i = getelementptr %struct.ibmpex_sensor_data, %struct.ibmpex_sensor_data* %100, i64 %indvars.iv.i, i32 3, i64 0, i32 0, i32 0, i32 0, !dbg !4699"
#strLine = "  %add.ptr.i = getelementptr %struct.rvt_dev_info, %struct.rvt_dev_info* %call.i, i64 2, i32 0, i32 13, i32 0, i32 0, i32 10, i32 2, !dbg !14828"
#strLine = "  %6 = bitcast i32 (%struct.ib_ah*, %struct.rdma_ah_attr*, i32, %struct.ib_udata*)** %pcidev.i to %struct.pci_dev**, !dbg !14831"
#strLine = "  %next.i = getelementptr %struct.iscsi_iser_task, %struct.iscsi_iser_task* %iser_task, i64 0, i32 0, i32 9, i64 %sub.i, i32 0, i32 0, i32 0, !dbg !14537"
#strLine = "  %send.i = getelementptr %struct.iscsi_iser_task, %struct.iscsi_iser_task* %iser_task, i64 0, i32 0, i32 9, i64 %idxprom.i, i32 0, i32 0, !dbg !14534"
#strLine = "  %next.i.i = getelementptr %struct.iscsi_iser_task, %struct.iscsi_iser_task* %task, i64 0, i32 0, i32 9, i64 %sub.i.i, i32 0, i32 0, i32 0, !dbg !15034"
#strLine = "  %wr_cqe.i.i = bitcast %union.anon.157* %103 to %struct.ib_cqe**, !dbg !15049"
#strLine = "  %103 = getelementptr %struct.iscsi_iser_task, %struct.iscsi_iser_task* %task, i64 0, i32 0, i32 9, i64 %idxprom.i.i, i32 0, i32 0, i32 1, !dbg !15049"
#strLine = "  %opcode.i.i = getelementptr %struct.iscsi_iser_task, %struct.iscsi_iser_task* %task, i64 0, i32 0, i32 9, i64 %idxprom.i.i, i32 0, i32 0, i32 4, !dbg !15047"
#strLine = "  %add.ptr2.i = getelementptr %struct.qib_devdata, %struct.qib_devdata* %call, i64 1, i32 0, i32 0, i32 0, i32 13, i32 0, i32 0, i32 20, !dbg !14142"
#strLine = "  %add.ptr.i = getelementptr %struct.qib_devdata, %struct.qib_devdata* %call, i64 1, !dbg !14136"
#strLine = "  %add.ptr2.i = getelementptr %struct.qib_devdata, %struct.qib_devdata* %call, i64 1, i32 0, i32 0, i32 0, i32 18, i64 24, !dbg !14228"
#strLine = "  %5 = getelementptr %struct.st5481_adapter, %struct.st5481_adapter* %adapter, i64 0, i32 3, i32 0, i32 1, i64 %and.i, i32 0, i32 0, !dbg !4748"
#strLine = "  %fe22 = getelementptr %struct.dvb_usb_device, %struct.dvb_usb_device* %5, i64 0, i32 10, i64 0, i32 9, i64 0, i32 0, !dbg !11808"
#strLine = "  %4 = load %struct.i2c_adapter* (%struct.dvb_frontend*, i32, i32)*, %struct.i2c_adapter* (%struct.dvb_frontend*, i32, i32)** %get_i2c_master, align 8, !dbg !11806"
#strLine = "  %1 = load i8*, i8** getelementptr inbounds (<{ { i8*, i32, i32, i32, i32*, i32 (%struct.CHIPSTATE*)*, i32 (%struct.CHIPSTATE*)*, i32, { i32, <{ i8, i8, [255 x i8] }> }, i32, i32, i32, i32, i32, i32, i32, i32 (i32)*, i32 (i32)*, i32 (i32)*, i32 (%struct.CHIPSTATE*)*, void (%struct.CHIPSTATE*, i32)*, i32, [4 x i32], i32, i32 }, { i8*, i32, i32, i32, i32*, i32 (%struct.CHIPSTATE*)*, i32 (%struct.CHIPSTATE*)*, i32, { i32, <{ i8, i8, i8, i8, [253 x i8] }> }, i32, i32, i32, i32, i32, i32, i32, i32 (i32)*, i32 (i32)*, i32 (i32)*, i32 (%struct.CHIPSTATE*)*, void (%struct.CHIPSTATE*, i32)*, i32, [4 x i32], i32, i32 }, %struct.CHIPDESC, %struct.CHIPDESC, { i8*, i32, i32, i32, i32*, i32 (%struct.CHIPSTATE*)*, i32 (%struct.CHIPSTATE*)*, i32, { i32, <{ [8 x i8], [249 x i8] }> }, i32, i32, i32, i32, i32, i32, i32, i32 (i32)*, i32 (i32)*, i32 (i32)*, i32 (%struct.CHIPSTATE*)*, void (%struct.CHIPSTATE*, i32)*, i32, [4 x i32], i32, i32 }, { i8*, i32, i32, i32, i32*, i32 (%struct.CHIPSTATE*)*, i32 (%struct.CHIPSTATE*)*, i32, { i32, <{ [12 x i8], [245 x i8] }> }, i32, i32, i32, i32, i32, i32, i32, i32 (i32)*, i32 (i32)*, i32 (i32)*, i32 (%struct.CHIPSTATE*)*, void (%struct.CHIPSTATE*, i32)*, i32, [4 x i32], i32, i32 }, %struct.CHIPDESC, %struct.CHIPDESC, %struct.CHIPDESC, %struct.CHIPDESC, %struct.CHIPDESC, { i8*, i32, i32, i32, i32*, i32 (%struct.CHIPSTATE*)*, i32 (%struct.CHIPSTATE*)*, i32, { i32, <{ i8, i8, [255 x i8] }> }, i32, i32, i32, i32, i32, i32, i32, i32 (i32)*, i32 (i32)*, i32 (i32)*, i32 (%struct.CHIPSTATE*)*, void (%struct.CHIPSTATE*, i32)*, i32, [4 x i32], i32, i32 }, %struct.CHIPDESC }>, <{ { i8*, i32, i32, i32, i32*, i32 (%struct.CHIPSTATE*)*, i32 (%struct.CHIPSTATE*)*, i32, { i32, <{ i8, i8, [255 x i8] }> }, i32, i32, i32, i32, i32, i32, i32, i32 (i32)*, i32 (i32)*, i32 (i32)*, i32 (%struct.CHIPSTATE*)*, void (%struct.CHIPSTATE*, i32)*, i32, [4 x i32], i32, i32 }, { i8*, i32, i32, i32, i32*, i32 (%struct.CHIPSTATE*)*, i32 (%struct.CHIPSTATE*)*, i32, { i32, <{ i8, i8, i8, i8, [253 x i8] }> }, i32, i32, i32, i32, i32, i32, i32, i32 (i32)*, i32 (i32)*, i32 (i32)*, i32 (%struct.CHIPSTATE*)*, void (%struct.CHIPSTATE*, i32)*, i32, [4 x i32], i32, i32 }, %struct.CHIPDESC, %struct.CHIPDESC, { i8*, i32, i32, i32, i32*, i32 (%struct.CHIPSTATE*)*, i32 (%struct.CHIPSTATE*)*, i32, { i32, <{ [8 x i8], [249 x i8] }> }, i32, i32, i32, i32, i32, i32, i32, i32 (i32)*, i32 (i32)*, i32 (i32)*, i32 (%struct.CHIPSTATE*)*, void (%struct.CHIPSTATE*, i32)*, i32, [4 x i32], i32, i32 }, { i8*, i32, i32, i32, i32*, i32 (%struct.CHIPSTATE*)*, i32 (%struct.CHIPSTATE*)*, i32, { i32, <{ [12 x i8], [245 x i8] }> }, i32, i32, i32, i32, i32, i32, i32, i32 (i32)*, i32 (i32)*, i32 (i32)*, i32 (%struct.CHIPSTATE*)*, void (%struct.CHIPSTATE*, i32)*, i32, [4 x i32], i32, i32 }, %struct.CHIPDESC, %struct.CHIPDESC, %struct.CHIPDESC, %struct.CHIPDESC, %struct.CHIPDESC, { i8*, i32, i32, i32, i32*, i32 (%struct.CHIPSTATE*)*, i32 (%struct.CHIPSTATE*)*, i32, { i32, <{ i8, i8, [255 x i8] }> }, i32, i32, i32, i32, i32, i32, i32, i32 (i32)*, i32 (i32)*, i32 (i32)*, i32 (%struct.CHIPSTATE*)*, void (%struct.CHIPSTATE*, i32)*, i32, [4 x i32], i32, i32 }, %struct.CHIPDESC }>* @chiplist, i64 0, i32 0, i32 0), align 16, !dbg !6078"
#strLine = "  %marker.sroa.7 = alloca <{ i8, i16, %struct.mac_addr, i32, i16, i8, i8, [90 x i8] }>, align 8"
#strLine = "  %rx_status.sroa.9 = alloca <{ i8, i16, i8, i8, i8 }>, align 2"
#strLine = "  %arraydecay = getelementptr %struct.wmi_10_2_4_host_swba_event, %struct.wmi_10_2_4_host_swba_event* %1, i64 0, i32 1, i64 %i.0106, i32 0, i32 2, i64 0, !dbg !16857"
#strLine = "  %arraydecay = getelementptr %struct.wmi_10_4_host_swba_event, %struct.wmi_10_4_host_swba_event* %1, i64 0, i32 1, i64 %i.0119, i32 0, i32 2, i64 0, !dbg !16874"
#strLine = "  %phy_qcfg_resp.sroa.17.i.i = alloca { i8, [16 x i8], [16 x i8], [7 x i8] }, align 8"
#strLine = "  %rx_status.sroa.41.i.i.i = alloca <{ i8, [4 x i8], i8, i8, [2 x i8] }>, align 8"
#strLine = "  %rx_status.sroa.9 = alloca <{ i8, i16 }>, align 2"
#strLine = "  %rx_status.sroa.28 = alloca \<\{ i8, [4 x i8], i8, i8, [2 x i8] \}\>, align 8"
#strLine = "  %config_dev.sroa.7 = alloca { i32, [25 x i32], i16, i8, i8 }, align 8"
#strLine = "  %sds_mbx.sroa.8.i = alloca { i16, [2 x i16] }, align 8"
#strLine = "  %rx_status.sroa.18 = alloca <{ i8, [4 x i8], i8, i8, [2 x i8] }>, align 8"
#strLine = "  %rx_status.sroa.18 = alloca <{ i8, [4 x i8], i8, i8, [2 x i8] }>, align 8"
#strLine = "  %attr1.i = getelementptr [41 x %struct.bq24190_sysfs_field_info], [41 x %struct.bq24190_sysfs_field_info]* @bq24190_sysfs_field_tbl, i64 0, i64 %indvars.iv.i, i32 0, i32 0, !dbg !6915"
#strLine = "%attr1.i.2 = getelementptr [41 x %struct.bq24190_sysfs_field_info], [41 x %struct.bq24190_sysfs_field_info]* @bq24190_sysfs_field_tbl, i64 0, i64 %indvars.iv.next.i.1, i32 0, i32 0, !dbg !6915"
#strLine = "  %buf.sroa.6.i = alloca { i8, [6 x i8] }, align 4"
#strLine = "  %rx_status.sroa.5358 = alloca [16 x i8], align 8"
#strLine = "  %v.sroa.66 = alloca { i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, [4 x i32] }, align 8"
#strLine = "  %v.sroa.0 = alloca { i32, i32, i32, i32, i32, i32 }, align 8"
#strLine = "  %v.sroa.50 = alloca { i32, i32, i32, i32, i32 }, align 8"
#strLine = " %v.sroa.51 = alloca { i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, [4 x i32] }, align 8"
#strLine = "  %sig_hdr.sroa.5123 = alloca { i64, i64, i32, i32, i32, i32, i64, i32, i32, i64, i64, i64, i64, i32, [12 x i8] }, align 8"
strLine = "  %sig_hdr.sroa.8 = alloca { i64, i32, i32, i64, i64, i64, i64, i32, [12 x i8] }, align 8"
