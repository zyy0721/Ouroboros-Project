; ModuleID = 'testExample_1.cpp'
source_filename = "testExample_1.cpp"
...
define dso_local i32* @_Z4fun3iPiPS_(i32 %n, i32* %ptr, i32** %pptr) #3 {
entry:
  %n.addr = alloca i32, align 4
  %ptr.addr = alloca i32*, align 8
  %pptr.addr = alloca i32**, align 8
  ...
  store i32* %ptr, i32** %ptr.addr, align 8
  store i32** %pptr, i32*** %pptr.addr, align 8
  %0 = load i32**, i32*** %pptr.addr, align 8
...
if.else:                                          ; preds = %entry
  ...
  %16 = load i32**, i32*** %pptr.addr, align 8
  %17 = load i32*, i32** %16, align 8
  %18 = load i32**, i32*** %pptr.addr, align 8
  %call1 = call i32* @_Z4fun3iPiPS_(i32 %15, i32* %17, i32** %18)
  store i32* %call1, i32** %ptr.addr, align 8
  %19 = load i32**, i32*** %pptr.addr, align 8
  store i32* %n.addr, i32** %19, align 8
  %20 = load i32**, i32*** @globalD, align 8
  store i32** %20, i32*** %retval, align 8
  br label %return

return:                                           ; preds = %if.else, %if.then
  %21 = load i32**, i32*** %retval, align 8
  ret i32** %21
}
