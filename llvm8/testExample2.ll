; ModuleID = 'testExample2.cpp'
source_filename = "testExample2.cpp"
...
entry:
  ...
  %call2 = call i32** @_Z4fun4RPiPS_(i32** dereferenceable(8) %ptr.addr, i32** %ptr.addr)
...
define dso_local i32** @_Z4fun4RPiPS_(i32** dereferenceable(8) %ptr, i32** %pptr) #3 {
entry:
  %ptr.addr = alloca i32**, align 8
  %pptr.addr = alloca i32**, align 8
